...
return (
<div
className="min-h-screen bg-[#020810] flex items-center justify-center p-4"
style={{
backgroundImage:
'radial-gradient(ellipse at 50% 0%, #0a2540 0%, #020810 70%)',
}}
>
{/* Grid Overlay */}
<div
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full bg-[#0a1628]/60 border border-cyan-500/30 rounded-lg pl-9 pr-4 py-2.5 text-sm text-white placeholder-slate-600 focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400/40 transition-all"
            />
          </div>
        </div>
