    ...
    <header className={`sticky top-0 z-50 w-full transition-all duration-500 ${
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-6">
        ...
        <Link href="#home" className="flex items-center gap-3 group relative">
          <motion.div 
            className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-accent relative"
            whileHover={{ scale: 1.1, rotate: 5 }}
            whileTap={{ scale: 0.95 }}
          >
            <BiBuildings className="text-lg text-primary-foreground" />
            <div className="absolute inset-0 rounded-xl bg-primary/20 blur-lg opacity-0 group-hover:opacity-100 transition-opacity" />
          </motion.div>
          <span className="hidden font-bold text-foreground md:inline text-sm bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
            CIO Tech Leadership
          </span>
        </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button 
              size="sm" 
              asChild 
              className="bg-gradient-to-r from-primary to-accent text-white font-semibold hover:shadow-lg hover:shadow-primary/40"
            >
